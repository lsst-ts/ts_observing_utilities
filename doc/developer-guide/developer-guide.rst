...
#########################################
ObservingUtilties Developer Guide
#########################################
...
.. automodapi:: lsst.ts.observing.utilities
    :no-main-docstr:
...
Updating Firmware of the ObservingUtilties
==========================================
...
Feature requests can be made by filing a Jira ticket with the `ObservingUtilties` label.
In all cases, reaching out to the :ref:`contacts for this CSC <ts_xml:index:master-csc-table:ObservingUtilties>` is recommended.
